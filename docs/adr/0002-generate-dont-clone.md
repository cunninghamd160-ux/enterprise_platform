...
SDK change like any other. `scaffold_version` records what generated the app; the SDK version is
already determined by the workspace and is not duplicated in the manifest.
